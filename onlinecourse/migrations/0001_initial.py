# Generated by Django 3.1.3 on 2023-08-08 00:00
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.CharField(choices=[('radio', 'Multiple Choice'), ('text', 'Short-answer')], max_length=10)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('choice', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='questions', to='onlinecourse.choice')),
                ('quiz', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='onlinecourse.quiz')),
            ],
        ),
        migrations.CreateModel(
            name='Learner',
